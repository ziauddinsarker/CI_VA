                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        <?php if($this->session->userdata('user_id') && $this->session->userdata('user_type') == 'admin') { ?>
                            ...
                            <li>
                                <a href="<?php echo base_url("admin/all_blog")?>"><i class="fa fa-wrench fa-fw"></i>Post</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("admin/event")?>"><i class="fa fa-bar-chart-o fa-fw"></i>Event</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("admin/discount")?>"><i class="fa fa-bar-chart-o fa-fw"></i>Discount</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("admin/doctor")?>"><i class="fa fa-bar-chart-o fa-fw"></i>Doctor</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("admin/medicine")?>"><i class="fa fa-bar-chart-o fa-fw"></i>Medicine</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url("admin/user")?>"><i class="fa fa-bar-chart-o fa-fw"></i>User</a>
                            </li>
